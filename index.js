...
const coke = createMenuItem('Coca-Cola',2,'Drinks')
const dietpepsi = createMenuItem('Diet Pepsi',2.5,'Drinks')
const drpepper = createMenuItem('Dr. Pepper',3,'Drinks')
...
reviews.push({name: "Jiawei", rating: 3, feedback: "The food is quick and decent"})
console.log(reviews)
